...
namespace photoTimer.lib
{
    public class WaterMarkHelper
    {
        ...
        public static void AddImageSignText(string imgPath, string filename, string watermarkText, int watermarkStatus, int quality, int fontsize, Color color, string fontname = "微软雅黑")
        {
            ...
            Bitmap obj = new Bitmap(width, height);
            ...
            if (ici != null)
                obj.Save(filename, ici, encoderParams);
            else
                obj.Save(filename);
